    ...
    return (
        ...
        <div className="w-full bg-white">
            <div className="flex flex-col items-center pb-10 mt-20">
                ...
                <Link to={`/user/asqvn/${patient.id_patients}`} className="inline-flex mt-4 items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Làm khảo sát ASQ-VN</Link>
            </div>
        </div>
